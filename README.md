...
# TUNAJENGA-COMPANY-LIMITED operation and Incident Response Self-RAG Copilot

A production-style **Self-RAG** demo for company operations and incident response. It searches private operational knowledge in Pinecone first, self-grades the retrieved evidence, corrects weak retrieval/generation, and uses **internet search only when the private knowledge base is insufficient**.
...
#creating the virtual environment to execute the project

# windows
conda create self_rag_tunajenga python = 3 -y

conda activate self_rag_tunajenga

pip install -r requirements.text

#  linux
 python3 -m venv tunajenga_company

 source tunajenga_company/bin/activate
